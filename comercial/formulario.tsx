    ...
    return (
      <header className="relative h-screen flex flex-col items-center justify-center text-center p-4 bg-gradient-to-br from-accent-blue to-accent-lavender overflow-hidden">
        <img
          ...
          alt="Logo LABirintar"
          className={`w-[350px] max-w-[80%] mb-8 drop-shadow-md ${getFadeInClass(
            isLogoVisible
          )}`}
        ...
        <h1
          ref={titleRef}
          className={`font-lora text-white text-shadow text-[clamp(2.8rem,6vw,4.5rem)] leading-tight shadow-black/20 ${getFadeInClass(
            isTitleVisible
          )}`}
        ...
        <p
          ref={subtitleRef}
          className={`text-xl text-white font-light tracking-wider mt-4 text-shadow shadow-black/15 ${getFadeInClass(
            isSubtitleVisible
          )}`}
...
const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    tooltip:
      "Programação de Jogos, Robótica, Criação de Jogos de Tabuleiro e RPG",
  },
  {
    title: "CidadeVamos",
    folder: "cidadevamos",
  ...
  },
  {
    ...
    folder: "brincarlivre",
    images: [
      "8c01a9ee-c495-41bd-926e-4ee64715ef30.jpeg",
      "IMG_1801.jpeg",
      "IMG_1804.jpeg",
      "IMG_1811.jpeg",
      "IMG_1830.jpeg",
  ...
  },
  {
    ...
    tooltip:
      "Clube de Leitura, CrioLivros, Artes Visuais, Artes Cênicas, Improvisação, Dança e Música",
  },
  {
